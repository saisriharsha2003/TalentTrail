      ...
      >
        <div className="bg-primary p-4 text-white text-center">
          ...
          <p className="mb-0 opacity-75">
            Upload your resume to pre-fill your details
          </p>
        </div>
        ...
        <div className="card-body p-4 p-md-5 text-center">
              ...
              <div className="text-muted">
                ...
                {selectedFile ? (
                  <>
                    ...
                    <small className="opacity-75">Click to change file</small>
                  </>
                ) : (
                  <>
          ...
          <div className="d-grid gap-3">
            <button
              className="btn btn-primary py-3 rounded-3 fw-bold shadow-sm"
          ...
          <div className="mt-4 p-3 bg-light rounded-3 text-start">
            ...
            <small className="text-muted">
              Our AI will extract your education, skills, and experience from
              your resume to save you time during registration.
            </small>
          </div>
        </div>
      </div>
