...
const Layout = () => {
    ...
    useEffect(() => {
        ...
        if (user.userInfo.role === 'admin' || user.userInfo.role === 'college') return;
    ...
    const handleLogout = async () => {
        try {
            if (user?.userInfo?.role) {
                await axios.post('/logout', { role: user.userInfo.role });
            }
            ...
            <nav className="navbar px-2" data-bs-theme="dark" style={{ backgroundColor: '#0f172a' }}>
                ...
                <div className="container-fluid">
                    <div className='d-flex align-items-center'>
                        ...
                        <Link className="navbar-brand mx-5 fs-3 pacifico-regular" to={link || "/"}>
                            Talentrail
                        </Link>
                    </div>
