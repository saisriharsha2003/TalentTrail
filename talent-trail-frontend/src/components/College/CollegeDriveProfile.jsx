        ...
        <div className="container-fluid py-4 bg-light min-vh-100">
            <div className="d-flex justify-content-between align-items-center mb-5 mx-4">
                <div>
                    ...
                    <p className="text-muted mb-0">Detailed overview of the recruitment drive.</p>
                </div>
                    ...
                    <div className="card border-0 shadow-sm rounded-4 overflow-hidden mb-4">
                        <div className="bg-primary p-4 text-white d-flex justify-content-between align-items-center">
                            ...
                            <div className="bg-white bg-opacity-25 rounded-3 px-3 py-2 text-center">
                                <span className="d-block small text-uppercase fw-bold">Package</span>
                                <span className="fs-5 fw-bold">{job.salaryRange || job.package || 'N/A'}</span>
                            </div>
                        </div>
                        ...
                        <div className="card-body p-4 p-md-5">
                            <div className="row g-4">
                                <div className="col-md-8">
                                    ...
                                    <div className="p-4 bg-light rounded-4 text-muted" style={{ lineHeight: '1.8' }}>
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <div className="d-flex flex-wrap gap-2">
                                                {job.skills.map((skill, index) => (
                                                    <span key={index} className="badge bg-primary bg-opacity-10 text-primary rounded-pill px-3 py-2 border border-primary border-opacity-25">
                                                        {skill}
                                                    </span>
                                                ))}
                                            </div>
                                        ...
                                        <div className="card-body p-4">
                                            ...
                                            <div className="d-flex align-items-center mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <span className="fw-bold text-dark">{job.location || 'Remote'}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="d-flex align-items-center mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <span className="fw-bold text-dark">{job.experienceRequired || job.experience || 'Fresher'}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="d-flex align-items-center mb-3">
                                                ...
                                                <div>
                                                    <small className="text-muted d-block">Min. CGPA</small>
                                                    <span className="fw-bold text-dark">{job.cgpa || 'No criteria'}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="d-flex align-items-center mb-0">
                                                ...
                                                <div>
                                                    ...
                                                    <span className="fw-bold text-dark">{job.numberOfOpenings || job.seats || 'N/A'} Positions</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
