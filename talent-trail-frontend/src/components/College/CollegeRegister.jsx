...
const CollegeRegister = () => {
  ...
  const handleInstitution = async (e) => {
    ...
    try {
      ...
      notify(
        "failed",
        err?.response?.data?.message || "Failed to save institution details",
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleAddCourse = async (e) => {
    e.preventDefault();
    if (!course.name || !course.duration || !course.specialization) {
      notify("failed", "Course name, duration and specialization are required");
      return;
    }
    setLoading(true);
    try {
        ...
        <div className="card-body p-4 p-md-5">
              ...
              <div className="row g-3">
                <div className="col-md-12 form-floating mb-3">
                  <input
                    ...
                    required
                  />
                  <label className="ms-2" htmlFor="in">
                    Institution Name
                  </label>
                </div>
                <div className="col-md-12 form-floating mb-3">
                  <input
                    ...
                    required
                  />
                  <label className="ms-2" htmlFor="iw">
                    Website URL
                  </label>
                </div>
                <div className="col-md-12 form-floating mb-3">
                  <textarea
                    ...
                    required
                  />
                  <label className="ms-2" htmlFor="ia">
                    Full Address
                  </label>
                </div>
                <div className="col-md-12 form-floating mb-3">
                  <input
                    ...
                    onChange={(e) =>
                      setInstitution({ ...institution, mobile: e.target.value })
                    }
                    required
                  />
                  <label className="ms-2" htmlFor="im">
                    Contact Number
                  </label>
                </div>
              </div>
                ...
                <div className="row g-3">
                  <div className="col-md-6 form-floating mb-2">
                    <input
                      ...
                      onChange={(e) =>
                        setPrincipal({ ...principal, fullName: e.target.value })
                      }
                      required
                    />
                  ...
                  <div className="col-md-6 form-floating mb-2">
                    <input
                      ...
                      onChange={(e) =>
                        setPrincipal({ ...principal, position: e.target.value })
                      }
                      required
                    />
                  ...
                  <div className="col-md-6 form-floating mb-2">
                    <input
                      ...
                      onChange={(e) =>
                        setPrincipal({ ...principal, mobile: e.target.value })
                      }
                      required
                    />
                ...
                <div className="row g-3">
                  <div className="col-md-6 form-floating mb-2">
                    <input
                      ...
                      onChange={(e) =>
                        setPlacement({ ...placement, fullName: e.target.value })
                      }
                      required
                    />
                    <label className="ms-2">Full Name</label>
                  ...
                  <div className="col-md-6 form-floating mb-2">
                    <input
                      ...
                      onChange={(e) =>
                        setPlacement({ ...placement, position: e.target.value })
                      }
                      required
                    />
                    <label className="ms-2">Position</label>
                  ...
                  <div className="col-md-6 form-floating mb-2">
                    <input
                      ...
                      onChange={(e) =>
                        setPlacement({ ...placement, mobile: e.target.value })
                      }
                      required
                    />
                    <label className="ms-2">Mobile</label>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-12 form-floating mb-2">
                    <input
                      ...
                      onChange={(e) =>
                        setCourse({ ...course, specialization: e.target.value })
                      }
                    />
                ...
                <div className="mb-4">
                  ...
                  <div className="list-group list-group-flush border rounded-4 overflow-hidden shadow-sm">
                    {courses.map((c, i) => (
                      <div
                        key={i}
                        className="list-group-item d-flex justify-content-between align-items-center bg-white p-3"
                      >
                        <div>
                          <span className="fw-bold text-primary">{c.name}</span>
                          <span className="text-muted mx-2">•</span>
                          <span className="badge bg-primary bg-opacity-10 text-black border px-2 py-1 rounded-pill">
          ...
          {step === 4 && (
            ...
            >
              ...
              <div className="mb-5">
                <div
                  className="upload-container mx-auto mb-4 border-2 border-dashed rounded-4 p-5 bg-light position-relative overflow-hidden shadow-sm"
